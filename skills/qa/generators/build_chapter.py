...
<li><strong>וקובץ נהלים בשם <bdi dir="ltr">CLAUDE.md</bdi></strong> - נסביר עליו בהמשך, ובינתיים רק אל תמחקו אותו.</li>
</ul>
...
<p><strong>ואם בכל זאת נתקעתם - פנו אלינו.</strong> דרך האתר, או בקבוצות הוואטסאפ שלנו, שכידוע לכם אינן שקטות במיוחד. <strong>עדיף שתשאלו אותנו מאשר שתוותרו.</strong></p>
</aside>
...
<p><strong>מה עושים: סוגרים אותו ב-<bdi dir="ltr">X</bdi>.</strong> הוא לא קשור לתרגיל. <bdi dir="ltr">Claude</bdi> קורא את המסמכים בעצמו, בלי שום תוספת.</p>
...
<p><strong>חמש שורות בטבלה, וכל אחת מהן נכונה.</strong> בדקנו כל הפניה מול הפרוטוקול עצמו: <strong>עמוד ושורה מדויקים, אפס שורות מומצאות.</strong></p>

<p>ושלושה מקומות נוספים שהוא <strong>לא</strong> הכניס לטבלה אלא ל"טעון בדיקה", עם הנימוק:</p>

<aside class="content-box legal-example">
<p><em>"עמוד 344 שורה 10: 'דרישת התשלום שיצאה מהמשרד שלי נקבה ב-15 במרץ'. לא ברור מלשון האמירה אם 15.03 הוא המועד שנדרש בו התשלום, או התאריך שבו יצאה הדרישה. <strong>לא הוכנס לטבלה כדי לא להכריע בין שתי הקריאות.</strong> יש לבדוק מול דרישת התשלום עצמה."</em></p>
...
<p><strong>ועוד דבר שהוא שם לב אליו ואנחנו לא:</strong> שלוש מהשורות בטבלה נוקבות יום וחודש <strong>בלי שנה</strong>, והוא סימן זאת בנפרד.</p>
...
<p><strong>עשרים מתוך עשרים תואמים. אפס אי-התאמות.</strong></p>

<p>ולפני זה, משפט אחד ששווה לשים לב אליו:</p>

<aside class="content-box legal-example">
<p><em>"הגרלתי את עשרים המסמכים <strong>לפני</strong> שכתבתי את הטבלה, כדי שהבחירה לא תושפע ממה שרשמתי. כל אחד מהם נפתח מחדש והושווה מול העמוד עצמו."</em></p>
<p><strong>הוא הגריל לפני, ולא אחרי.</strong> כדי שלא ייבחר דווקא במסמכים שהוא בטוח בהם.</p>
</aside>
...
לקבל תאריך חתימה בבורר תאריכים, ולהציג אותו במבנה יום/חודש/שנה ולא בפורמט אמריקאי.
