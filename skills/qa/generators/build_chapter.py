...
<h3>10 · פתחתי את הקובץ שהוא כתב, והוא נראה כמו קוד</h3>
...
<p><strong>לחיצה ימנית על הקובץ ברשימה, ואז <bdi dir="ltr">Open Preview</bdi></strong> - הפריט הראשון בתפריט.</p>
...
<aside class="content-box info">
<p><strong>ולמה הוא בכלל כותב בפורמט הזה:</strong> קובץ כזה נפתח בכל מחשב בלי תוכנה מיוחדת, אפשר לחפש בו, והוא נשאר קריא גם בעוד עשר שנים. <strong>ומי שרוצה אותו כמסמך <bdi dir="ltr">Word</bdi> - פשוט מבקש ממנו, והוא ימיר.</strong></p>
</aside>
...
<aside class="content-box recommendation">
<p><strong>נתקעתם? משהו נראה אחרת ממה שכתוב כאן?</strong> שווה לחזור לפרק <a href="#panic"><strong>"<bdi dir="ltr">Claude</bdi> מתארח כאן"</strong></a> - יש סיכוי טוב שהתשובה כבר מחכה שם.</p>
</aside>
</section>
...
<h3>ההוראה, ומה היא מבקשת</h3>

<p><strong>נבקש ממנו לקרוא את חמשת מסמכי התיק, לכתוב תקציר נפרד לכל אחד, ולרכז את כולם לציר זמן אחד.</strong> שישה קבצים חדשים בסך הכל.</p>

<p><strong>והפעם ההוראה קצרה בכוונה</strong>, כי מה שמעניין אותנו אינו התוצר אלא מה שקורה אחריו. <strong>אנחנו רק צריכים שיהיה מה לבטל.</strong></p>
...
<aside class="content-box info">
<p><strong>ושוב אותם ארבעים סרוקים מתרגיל 1, ובכוונה.</strong> שם הוא תייק אותם ונתן להם שמות. <strong>כאן הוא בונה עליהם טבלה ואז חוזר לבדוק אם מה שכתב נכון</strong> - ולכן טוב שהחומר כבר מוכר לכם, ואפשר להסתכל רק על מה שחדש.</p>
</aside>
...
<p><strong>ושבעה ימי עסקים זה לא שבעה ימים.</strong> צריך לדלג ולספור, <strong>וזה בדיוק הדבר שנופלים בו כשסופרים ביד</strong>, ושאף אחד לא רוצה לעשות פעמיים.</p>

<aside class="content-box warning">
<h3>ולפני זה, נקודה שחשוב שתדעו</h3>
<p><strong>אין בדין הישראלי הגדרה אחת של "יום עסקים".</strong> יש הגדרות בהקשרים מסוימים, למשל בכללי הבנקאות, ובדרך כלל ההסכם עצמו מגדיר מה נחשב יום עסקים לצורכו.</p>
<p><strong>וההסכם שבתיקייה אינו מגדיר.</strong> הוא כותב "שבעה ימי עסקים" ולא אומר מה נכלל בהם.</p>
<p><strong>ולכן הנוהג המקובל</strong> - לא לספור שישי, שבת וחגים - <strong>הוא נקודת מוצא ולא כלל מחייב,</strong> וההכרעה בשאלה כזאת היא שלכם ולא של הכלי. תכף תראו שהוא עצמו אומר את זה.</p>
</aside>
...
<ul class="bullets">
<li><strong>"שלושה שדות נפרדים: יום, חודש, שנה".</strong> בלי זה מי שיקליד <bdi dir="ltr">04/02</bdi> ויתכוון ל-4 בפברואר יקבל חישוב על 2 באפריל, <strong>ולא יידע.</strong></li>
...
לחשב את המועד לרישום הערת אזהרה לפי סעיף 4.1, כלומר שבעה ימי עסקים ממועד החתימה. ההסכם אינו מגדיר מהו יום עסקים, ולכן הנח לפי הנוהג המקובל שאינו כולל שישי, שבת וחגים, וכתוב בדף עצמו במפורש שזו הנחה ושההסכם שותק בעניין.
...
HTML = HTML.replace("__FIG_EX5DAYCOUNT__", shot("ex5-daycount",
    ...
    legend=["<strong>שישי ושבת מסומנים \"לא\", ולידם כתוב למה.</strong> הספירה מדלגת עליהם וממשיכה, <strong>ולכן בדוגמה הזאת שבעה ימי עסקים נמשכים אחד עשר ימי לוח.</strong> תאריך חתימה אחר ייתן מספר אחר."]))
